...
server: TCPServer.cpp Group.cpp TCPClient.cpp ControlMessage.cpp ClientEntry.cpp
	g++ $(FLAGS) TCPServer.cpp Group.cpp TCPClient.cpp ControlMessage.cpp ClientEntry.cpp -lboost_serialization -pthread -o server
